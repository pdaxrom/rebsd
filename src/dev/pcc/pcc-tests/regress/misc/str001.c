...
wchar_t w0[] = L"wide-string";	/* wide-string */
wchar_t _w0[12] = { 0x77, 0x69, 0x64, 0x65, 0x2d, 0x73, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x00 };

wchar_t w1[] = L"wide\0" "-\0" L"string";	/* multi-part wide-string */
wchar_t _w1[14] = { 0x77, 0x69, 0x64, 0x65, 0x00, 0x2d, 0x00, 0x73, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x00 };

char u0[] = "sⱦriƞg";	/* utf-8 string */
char _u0[10] = { 0x73, 0xe2, 0xb1, 0xa6, 0x72, 0x69, 0xc6, 0x9e, 0x67, 0x00 };

wchar_t u1[] = L"sⱦriƞg";	/* utf-8 wide-string */
wchar_t _u1[7] = { 0x73, 0x2c66, 0x72, 0x69, 0x19e, 0x67, 0x00 };
