 ...
 */
	...
	/* ARGSUSED */
int
Tcl_ProcCmd(void *dummy, Tcl_Interp *interp, int argc, unsigned char **argv)
{
...
int
TclGetFrame(Tcl_Interp *interp, unsigned char *string, CallFrame **framePtrPtr)
{
    register Interp *iPtr = (Interp *) interp;
    int level, result;
    CallFrame *framePtr;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_UplevelCmd(void *dummy, Tcl_Interp *interp, int argc, unsigned char **argv)
{
    register Interp *iPtr = (Interp *) interp;
    int result;
...
Proc *
TclFindProc(Interp *iPtr, unsigned char *procName)
{
    Tcl_HashEntry *hPtr;
    Command *cmdPtr;
...
static int
InterpProc(void *clientData, Tcl_Interp *interp, int argc, unsigned char **argv)
{
...
static void
ProcDeleteProc(void *clientData)
{
    register Proc *procPtr = (Proc *) clientData;
    register Arg *argPtr;
