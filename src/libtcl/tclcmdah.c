 ...
 */
	...
	/* ARGSUSED */
int
Tcl_BreakCmd(void *dummy, Tcl_Interp *interp, int argc, unsigned char **argv)
{
    if (argc != 1) {
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_CaseCmd(void *dummy, Tcl_Interp *interp, int argc, unsigned char **argv)
{
    int i, result;
    int body;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_CatchCmd(void *dummy, Tcl_Interp *interp, int argc, unsigned char **argv)
{
    int result;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_ConcatCmd(void *dummy, Tcl_Interp *interp, int argc, unsigned char **argv)
{
    if (argc == 1) {
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_ContinueCmd(void *dummy, Tcl_Interp *interp, int argc,
    unsigned char **argv)
{
    if (argc != 1) {
	Tcl_AppendResult(interp, "wrong # args: should be \"", argv[0],
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_ErrorCmd(void *dummy, Tcl_Interp *interp, int argc, unsigned char **argv)
{
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_EvalCmd(void *dummy, Tcl_Interp *interp, int argc, unsigned char **argv)
{
    int result;
    unsigned char *cmd;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_ExprCmd(void *dummy, Tcl_Interp *interp, int argc, unsigned char **argv)
{
    if (argc != 2) {
	Tcl_AppendResult(interp, "wrong # args: should be \"", argv[0],
		" expression\"", 0);
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_ForCmd(void *dummy, Tcl_Interp *interp, int argc, unsigned char **argv)
{
    int result, value;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_ForeachCmd(void *dummy, Tcl_Interp *interp, int argc,
    unsigned char **argv)
{
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_FormatCmd(void *dummy, Tcl_Interp *interp, int argc, unsigned char **argv)
{
