...
#ifdef DECO_N64
static void initn64ansi()
{
    /*
     * The N64 console implements a small ANSI/VT100 subset.  Keep deco on
     * that subset instead of using the full historic vt100 termcap entry,
     * which enables DEC graphics/keypad modes and scroll regions.
     */
    CL = "\033[2J\033[H";
    CM = "\033[%i%d;%dH";
    SO = MR = "\033[7m";
    ...
    IS = IF = FS = TI = TE = VS = VE = KS = KE = EA = 0;
    AL = DL = CS = SF = SR = 0;
    GS = GE = G1 = G2 = GT = AC = AS = AE = 0;
    AF = AB = Sf = Sb = CF = CB = 0;
    NF = NB = 0;
    ColorMode = 0;
    GraphMode = 0;
