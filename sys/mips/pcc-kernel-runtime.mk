...
PCC_KERNEL_RUNTIME_ENDIAN_CPP_big = -DTARGET_BIG_ENDIAN=1
PCC_KERNEL_RUNTIME_ENDIAN_CPP_little = -DTARGET_LITTLE_ENDIAN=1

ifeq ($(filter $(MIPS_ROOTFS_ENDIAN),big little),)
$(error PCC kernel runtime requires MIPS_ROOTFS_ENDIAN=big or little)
endif

$(PCC_KERNEL_RUNTIME_OBJS): CFLAGS += -Dos_rebsd \
    $(PCC_KERNEL_RUNTIME_ENDIAN_CPP_$(MIPS_ROOTFS_ENDIAN))
