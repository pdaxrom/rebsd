...
MIPS_CMD_SUBDIRS ?= basic calendar chown chroot compress date2 deco dhclient diff emg env \
                  find fold forth fsck getty hostname id ifconfig inetd init \
...
MIPS_DEV_PCC_SRCS = $(MIPS_NATIVE_PCC_BUILD_SCRIPT) \
...
MIPS_PCC_HOST_BUILD ?= /private/tmp/rebsd-mips-pcc-build-$(MIPS_ROOTFS_ABI)
MIPS_PCC_HOST_PREFIX ?= /private/tmp/rebsd-mips-pcc-install-$(MIPS_ROOTFS_ABI)
MIPS_CROSS_PCC_TARGET = $(MIPS_PCC_HOST_PREFIX)/mips-rebsd
MIPS_CROSS_PCC_LIB = $(MIPS_CROSS_PCC_TARGET)/lib
MIPS_CROSS_PCC_SOFTFLOAT_LIB = $(MIPS_CROSS_PCC_LIB)/softfloat
MIPS_HOST_PCC = $(MIPS_PCC_HOST_PREFIX)/bin/mips-rebsd-pcc
MIPS_CROSS_PCC_AS = $(MIPS_PCC_HOST_PREFIX)/bin/mips-rebsd-as
MIPS_CROSS_PCC_LD = $(MIPS_PCC_HOST_PREFIX)/bin/mips-rebsd-ld
MIPS_CROSS_PCC_AOUT = $(MIPS_PCC_HOST_PREFIX)/bin/mips-rebsd-aout
MIPS_CROSS_PCC_AR = $(MIPS_PCC_HOST_PREFIX)/bin/mips-rebsd-ar
MIPS_CROSS_PCC_RANLIB = $(MIPS_PCC_HOST_PREFIX)/bin/mips-rebsd-ranlib
MIPS_CROSS_PCC_NM = $(MIPS_PCC_HOST_PREFIX)/bin/mips-rebsd-nm
MIPS_CROSS_PCC_SIZE = $(MIPS_PCC_HOST_PREFIX)/bin/mips-rebsd-size
MIPS_CROSS_PCC_STRIP = $(MIPS_PCC_HOST_PREFIX)/bin/mips-rebsd-strip
...
MIPS_PCC_PROVIDER_DEPS = $(MIPS_HOST_PCC)
...
$(MIPS_LINPACK_ROOTFS_STAMP): $(MIPS_ROOTFS_USER_STAMP) $(MIPS_PCC_PROVIDER_DEPS) \
    $(MIPS_LINPACK_SMOKE_SCRIPT) $(MIPS_LINPACK_SMOKE_SRC)
...
rootfs.img: $(FSUTIL) $(MIPS_ROOTFS_BUILD_MANIFEST) $(MIPS_ROOTFS_USER_STAMP)
	rm -f $@
...
$(MIPS_HOST_PCC): $(MIPS_HOST_PORTABLECC_SCRIPT) $(MIPS_DEV_PCC_SRCS) \
	...
	sh $(MIPS_HOST_PORTABLECC_SCRIPT) $(abspath $(TOPSRC)) \
	    ...
	    $(abspath $(MIPS_ROOTFS_USR_INCLUDE)) \
...
$(MIPS_NATIVE_STAMP): $(MIPS_NATIVE_RUNTIME_SRCS) $(MIPS_PCC_PROVIDER_DEPS) \
	...
	$(MAKE) -C $(MIPS_NATIVE_TREE)/src/libc TARGET_PLATFORM=$(MIPS_ROOTFS_TARGET_PLATFORM) \
	    MIPS_ROOTFS_CPU=$(MIPS_ROOTFS_CPU) \
	    MIPS_ROOTFS_ENDIAN=$(MIPS_ROOTFS_ENDIAN) \
	    N64_USER_LDSCRIPT=$(abspath $(MIPS_ROOTFS_USER_LDSCRIPT)) \
	    CC="$(MIPS_PCC_RUNTIME_CC)" AS="$(MIPS_PCC_RUNTIME_AS)" \
	    AR="$(MIPS_PCC_AR)" \
	    RANLIB="$(MIPS_PCC_RANLIB)" \
	    LIBC_COMPILER_RUNTIME=libpcc clean all
	$(MIPS_PCC_RANLIB) $(MIPS_NATIVE_TREE)/src/libc.a
	$(MAKE) -C $(MIPS_NATIVE_TREE)/src/libm TARGET_PLATFORM=$(MIPS_ROOTFS_TARGET_PLATFORM) \
	    MIPS_ROOTFS_CPU=$(MIPS_ROOTFS_CPU) \
	    MIPS_ROOTFS_ENDIAN=$(MIPS_ROOTFS_ENDIAN) \
	    N64_USER_LDSCRIPT=$(abspath $(MIPS_ROOTFS_USER_LDSCRIPT)) \
	    CC="$(MIPS_PCC_RUNTIME_CC)" AS="$(MIPS_PCC_RUNTIME_AS)" \
	    AR="$(MIPS_PCC_AR)" \
	    RANLIB="$(MIPS_PCC_RANLIB)" clean all
