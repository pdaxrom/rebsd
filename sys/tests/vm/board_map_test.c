...
static const struct expected_region malta_map[] = {
    ...
    AVAILABLE(0x00180000u, 0x002fc000u, "ram"),
    RESERVED(0x002fc000u, 0x00300000u, "u0/u areas"),
...
static const struct expected_region n64_4m_map[] = {
    ...
    AVAILABLE(0x00080000u, 0x000f0000u, "rdram"),
    RESERVED(0x000f0000u, 0x000f4000u, "u0/u areas"),
