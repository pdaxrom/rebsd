...
struct pmap_tlb_diagnostics {
    ...
    unsigned   ptd_active_generation;
    unsigned   ptd_asid_generation;
    unsigned   ptd_next_asid;
    uint32_t   ptd_query_pte;
    unsigned   ptd_query_entryhi;
    unsigned   ptd_query_entrylo0;
    unsigned   ptd_query_entrylo1;
    unsigned   ptd_hardware_found;
    unsigned   ptd_hardware_index;
    unsigned   ptd_hardware_pagemask;
    unsigned   ptd_hardware_entryhi;
    unsigned   ptd_hardware_entrylo0;
    unsigned   ptd_hardware_entrylo1;
    unsigned   ptd_fast_sequence;
    unsigned   ptd_fast_last_epc;
    unsigned   ptd_fast_last_vaddr;
    unsigned   ptd_fast_last_at;
    unsigned   ptd_fast_last_v0;
    unsigned   ptd_fast_last_a0;
    unsigned   ptd_fast_last_cause;
    unsigned   ptd_fast_last_status;
    unsigned   ptd_fast_last_entryhi;
    unsigned   ptd_fast_last_entrylo0;
    unsigned   ptd_fast_last_entrylo1;
    unsigned   ptd_fast_last_index;
    unsigned   ptd_fast_last_random;
    unsigned   ptd_fast_last_count;
    unsigned   ptd_fast_last_pte_pair;
    unsigned   ptd_fast_last_directory;
    unsigned   ptd_fast_last_pte0;
    unsigned   ptd_fast_last_pte1;
    unsigned   ptd_fast_last_at_high;
    unsigned   ptd_fast_last_v0_high;
    unsigned   ptd_fast_last_a0_high;
