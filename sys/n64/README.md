...
2. Kernel uses N64cart UART for early console.
3. Root is a read-only UFS romdisk.
4. Swap/temp use a RAM-backed block device.
5. N64cart ROMFS is mounted later as a separate read-only filesystem.
